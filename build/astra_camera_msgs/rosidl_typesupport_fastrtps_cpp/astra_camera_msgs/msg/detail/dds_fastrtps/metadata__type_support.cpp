...
#include "astra_camera_msgs/msg/detail/metadata__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = astra_camera_msgs::msg::Metadata;
    is_plain =
      (
...
{
  return &astra_camera_msgs::msg::typesupport_fastrtps_cpp::_Metadata__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, astra_camera_msgs, msg, Metadata)() {
  return &astra_camera_msgs::msg::typesupport_fastrtps_cpp::_Metadata__handle;
}
