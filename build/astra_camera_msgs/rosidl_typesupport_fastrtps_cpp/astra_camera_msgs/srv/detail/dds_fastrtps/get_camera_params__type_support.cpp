  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = astra_camera_msgs::srv::GetCameraParams_Request;
    is_plain =
      (
...
static size_t _GetCameraParams_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetCameraParams_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = astra_camera_msgs::srv::GetCameraParams_Response;
    is_plain =
      (
...
static size_t _GetCameraParams_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetCameraParams_Response(full_bounded, is_plain, 0);
