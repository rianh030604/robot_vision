...
#include "astra_camera_msgs/srv/detail/get_int32__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = astra_camera_msgs::srv::GetInt32_Request;
    is_plain =
      (
...
static size_t _GetInt32_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetInt32_Request(full_bounded, is_plain, 0);
...
{
  return &astra_camera_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, astra_camera_msgs, srv, GetInt32_Request)() {
  return &astra_camera_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = astra_camera_msgs::srv::GetInt32_Response;
    is_plain =
      (
...
static size_t _GetInt32_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetInt32_Response(full_bounded, is_plain, 0);
...
{
  return &astra_camera_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, astra_camera_msgs, srv, GetInt32_Response)() {
  return &astra_camera_msgs::srv::typesupport_fastrtps_cpp::_GetInt32_Response__handle;
}
...
{
  return &astra_camera_msgs::srv::typesupport_fastrtps_cpp::_GetInt32__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, astra_camera_msgs, srv, GetInt32)() {
  return &astra_camera_msgs::srv::typesupport_fastrtps_cpp::_GetInt32__handle;
}
